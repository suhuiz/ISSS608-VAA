...
[**ggrepel**](https://ggrepel.slowkow.com/) ![](https://r4va.netlify.app/chap02/img/image3.jpg){width="42"} is an extension of **ggplot2** package which provides `geoms` for **ggplot2** to repel overlapping text as in our examples on the right.
...
## **Creating Composite Graphics: pathwork methods** ![](https://r4va.netlify.app/chap02/img/image4.png){width="52" height="59"}
