...
![](https://r4va.netlify.app/chap01/img/image1.jpg){width="40" height="47"} is an R package for **declaratively** creating **data-driven** graphics based on ***The Grammar of Graphics***

![](https://r4va.netlify.app/chap01/img/image5.png)

It is also part of the tidyverse family specially designed for visual exploration and communication.

![](https://r4va.netlify.app/chap01/img/image2.png)
